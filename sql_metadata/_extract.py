...
def extract_cte_names(
    ...
    """Backward-compat wrapper for ColumnExtractor.extract_cte_names."""
    return ColumnExtractor.extract_cte_names(ast, cte_name_map)


def extract_subquery_names(ast: exp.Expression) -> List[str]:
    """Backward-compat wrapper for ColumnExtractor.extract_subquery_names."""
    return ColumnExtractor.extract_subquery_names(ast)
