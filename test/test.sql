...
FROM SCHEMA.CRM_ARRANGEMENT AR
           ...
           JOIN SCHEMA.CRM_CASH_FLOW CF
            ...
            AND CF.RECEIPT_DATE BETWEEN TRUNCATE(&GLOBAL_P_EFFECTIVE_LOAD_DATE, 'MONTH') AND &GLOBAL_P_EFFECTIVE_LOAD_DATE
            AND CF.EFFECTIVE_LOAD_DATE BETWEEN TRUNCATE(&GLOBAL_P_EFFECTIVE_LOAD_DATE, 'MONTH') AND DATE('2020-01-01')
...
(P.TMO_HIER_LEVEL_4 = 'FAKTOR' OR P.TMO_HIER_LEVEL_3 = 'KÃNYSZERHITEL' OR AR.ESTIMATED_END_DATE - L.FIRST_DISBURSEMENT_DATE <= 365)
AND
